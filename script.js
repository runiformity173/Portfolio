const data = [
    ...
    ["Creature Evolution","This is a simulation of behavioral evolution. Creatures have randomly structured and weighted neural networks that decide their actions, while mutations and time help them fit to the survival conditions and show strong emergence.","https://runiformity173.github.io/misc/Evolution/","evolution1","https://github.com/runiformity173/runiformity173.github.io/tree/main/misc/Evolution","🧠"],
    ...
    ["Collision Simulator","This is a simple physics engine that I implemented from scratch with the Verlet integration technique for motion. Link balls with fixed-length connections and throw things around, or press \"dispense\" to see things in action.","https://runiformity173.github.io/misc/Collisions","collisions1","https://github.com/runiformity173/runiformity173.github.io/tree/main/misc/Collisions","💥"],
];
